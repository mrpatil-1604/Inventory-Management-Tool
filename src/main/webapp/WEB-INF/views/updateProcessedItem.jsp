...
<div class="grid-container">
  ...
  <fieldset>
  <form action="processUpdateItem"method="post"id="survey-form">
      <label id="name-label"> </label><input id="name" type="hidden"name="Id" value="<%=request.getParameter("Id")%>" required/>
