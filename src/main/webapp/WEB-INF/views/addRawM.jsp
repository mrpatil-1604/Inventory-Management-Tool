...
<div class="grid-container">
  ...
  <fieldset>
  <form action="processAddRaw"mathod="post"id="survey-form">
      <label id="name-label"> <b>Enter Id</b> </label><input id="name" type="number"name="Id" placeholder="Id" required/>
        <label id="lastname-label"> <b>Enter Material Name</b> </label><input id="name" name="name"type="text" placeholder="name" required/> 
          <label id="email-label"> <b>Enter Quantity</b> </label><input id="email" type="number"name="quantity"  required/> 
            <label id="number-label"> <b>Enter Unit</b> </label><input id="number" type="text" name="unit" min="17" required/>
			<label id="number-label"> <b>Cost per unit</b> </label><input id="number" type="number" name="costPerUnit" min="17"  required/><br>
