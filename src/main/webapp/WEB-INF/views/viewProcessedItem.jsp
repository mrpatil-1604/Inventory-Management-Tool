...
<body>
<%@page import = "com.mr.model.ProcessedItem" %>
      ...
      <tr>
        ...
        <td data-th="Due Date">
         ...
         <td data-th="Net Amount">
          <a href="issueProcessedM?Id=<%=rm.getId()%>&name=<%=rm.getName()%>">Issue</a>
        </td>
        <td data-th="Net Amount">
          <a href="updateProcessedItem?Id=<%=rm.getId()%>">Update</a>
        </td>
        <td data-th="Net Amount">
          <a href="deleteProcessed/<%=rm.getId()%>">Delete</a>
        </td>
      </tr>
      <%} %>  
    </tbody>
