...
<body>
<%@page import = "com.mr.model.LogsProcessedM" %>
...
<h1> Material Table</h1>
  <table class="rwd-table">
    <tbody>
      ...
      <%
      List<LogsProcessedM>logsProcessedM=(List<LogsProcessedM>)request.getAttribute("logsProcessedM");
      for(LogsProcessedM rm: logsProcessedM){
      %>
      <tr>
