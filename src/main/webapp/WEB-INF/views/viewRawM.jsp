...
<body>
<%@page import = "com.mr.model.RawMaterial" %>
      ...
      <tr>
        ...
        <td data-th="Due Date">
         ...
         <td data-th="Net Amount">
          <a href="issueRawM?Id=<%=rm.getId()%>&name=<%=rm.getName()%>">Issue</a>
        </td>
         <td data-th="Net Amount">
          <a href="updateRawM?Id=<%=rm.getId()%>">Update</a>
        </td>
       
        <td data-th="Net Amount">
          <a href="deleteRawM/<%=rm.getId()%>">Delete</a>
        </td>
